...
class TrainingConfig(Config):
    def __init__(
        ...
        self.should_save_training_state_to_gcp = None
        ...
        self.symlink_training_state_directory = None
        self.symlink_checkpoint_state_directory = None
        ...
        if self.experiment_dir is None:
            ...
            self._save_config(
                ...
                self.should_save_training_state_to_gcp,
            )
        ...
        if self.fifo_file is not None:
            print(self.fifo_file)
            with open(self.fifo_file, "w") as f:
                f.write(
                    f"-c {self.experiment_dir}/configs/* -tr checkpoint_directory_to_resume_training={self.experiment_dir}/checkpoints"
                )
    ...
    def get_experimentDir(self):
        ...
        saveTo_gcp(self.should_save_training_state_to_gcp, self.experiment_dir)
